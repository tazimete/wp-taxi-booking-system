<?php 
	...
	Plugin Name: WP Taxi Booking System

	Plugin URI: http://wordpress.org/plugins/ 
	
	Description: wp-taxi-booking-system is AJAX based wordpress plugin which permits users for booking taxi.Distance and price calculation will be done by google map api. And payment will be done with paypal.

	Author: AGM Tazim

	Version: 1.0

	Author URI: http://agm.me.tt/
